...
<html>
<body>
	<div class="px-6 py-4 bg-white/80 dark:bg-slate-900 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50">
		<div class="flex items-center justify-between">
			...
			<div class="flex-1 max-w-md mx-8">
				<div class="relative">
					<span class="material-symbols-rounded text-xl text-slate-500 dark:text-slate-300
								absolute top-1/2 transform -translate-y-1/2 left-1 p-2">
						search
					</span>
					<input
						type="text" 
						...
						class="w-full pl-10 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2
			...
			<div class="flex items-center space-x-3">
				...
				<!-- User profile -->
				<div class="flex items-center border-l border-slate-300 dark:border-slate-700 space-x-3 pl-3">
                      <img 
                      	alt="avatar" 
