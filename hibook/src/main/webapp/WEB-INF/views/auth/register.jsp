                    ...
                    <input type="hidden" name="csrfToken" value="${csrfToken}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group custom-input-group">
                                ...
                                <input type="date" class="border-0 form-control" id="inputBirthDate" name="birthDate" required="required" value="2004/05/17"/>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="checkAgree" checked="checked">
