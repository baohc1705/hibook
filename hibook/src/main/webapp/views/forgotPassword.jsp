        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 group_main p-5">
                ...
                <div class="group_form mt-3">
                    ...
                    <form id="form-sendEmail" action="<%= url1 %>/forgot-password" method="post" class="form px-5 mb-3" >
                    ...
                    <form id="form-resetPassword" action="<%= url1 %>/reset-password" method="post" class="form px-5" >
	                    <input type="hidden" id="userid" name="userid" value="${uid}" readonly="readonly">
                    	...
                    	<div class="mb-3">
	                        <input type="password" class="input-custom_border" id="password" name="password"
	                                  ...
	                                  <c:if test="${!tokenValid }">disabled="disabled"</c:if>/>
                        </div>
                        ...
                        <div class="mb-3">
	                        <input type="password" class="input-custom_border" id="confirmPassword" name="confirmPassword"
	                                  ...
	                                  <c:if test="${!tokenValid }">disabled="disabled"</c:if> onkeyup="checkPassword()" />
                        </div>
                    ...
                    <a href="<%= url1 %>/views/login.jsp" type="button" class="">TRỞ VỀ</a>                           
                </div>
            </div>
        </div>
    </div>
    					...
    					if (response.status === "success") {
    						Swal.fire({
    							  ...
    							  if (result.isConfirmed) {
    								  window.location.href = "<%= url1 %>/views/login.jsp"
    							  }
    						});
    					}
    					else {
