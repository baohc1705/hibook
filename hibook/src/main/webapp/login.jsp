...
<%@include file="asset/allLibary.jsp" %>
	...
	<div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 group_main p-5">
                <div class="logo-home">
                    <img src="asset/images/logo-home.png" alt="" height="50px" />
                </div>
                <div class="group_form mt-3">
                    ...
                    <form action="login" method="post" class="form px-5">
                        <div class="mb-3">
                    ...
                    <div class="group_logup text-center">
                        <p class="text-dark-blue-50 fs-6">
                            Bạn chưa phải thành viên? <a href="register.jsp" class="text-decoration-none ">Đăng ký tại đây</a>
                        </p>
                    </div>
                </div>
            </div>
